...
(function ($extKey = 'reint_downloadmanager', $iconIdentifier = 'reint-dm-icon') {
    ...
    mod.wizards.newContentElement.wizardItems {
        ...
        common {
            ...
            show := addToList(reintdownloadmanager_dmlist)
        }
    }
    mod.web_layout.tt_content.preview.reintdownloadmanager_dmlist = EXT:' . $extKey . '/Resources/Private/Templates/CEPreview/List.html
    ');
})();
