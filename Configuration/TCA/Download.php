	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_reintdownloadmanager_domain_model_download',
				'foreign_table_where' => 'AND tx_reintdownloadmanager_domain_model_download.pid=###CURRENT_PID### AND tx_reintdownloadmanager_domain_model_download.sys_language_uid IN (-1,0)',
			),
		),
