...
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin(
		$_EXTKEY, 
		'Reintdlm', 
		'LLL:EXT:reint_downloadmanager/Resources/Private/Language/locallang.xlf:plugin_label', 
		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY) . 'Resources/Public/download_icon.png'
);

// add wizard icon to the "add new record" in backend
if (TYPO3_MODE == "BE") {
	$TBE_MODULES_EXT["xMOD_db_new_content_el"]["addElClasses"]["ReintDownloadmanagerWizicon"] = 
			\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Classes/Helper/ReintDownloadmanagerWizicon.php';
}
